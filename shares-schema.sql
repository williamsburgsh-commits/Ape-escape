...
-- Function to check if URL is already used
...
-- Add revenge mode columns to profiles table
ALTER TABLE profiles 
ADD COLUMN IF NOT EXISTS revenge_mode_active BOOLEAN DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS revenge_mode_end_time BIGINT DEFAULT 0;
